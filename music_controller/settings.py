...
# 'django-insecure-%)9w$f!w^zwvf4@=a(x%l#%vi3yiuvr0^tpxem1$zg^by&6fu2'
...
##used for white noise
STATIC_ROOT = os.path.join(BASE_DIR, 'frontend/static')
    
##generic, used for grabbing static files, I cusomized mine bc I have a frontend folder
STATICFILES_DIRS = (
